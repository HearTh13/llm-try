...
def reset_rag_table():
    """
    Drop & buat ulang tabel rag_chunks sesuai dimensi embedding terkini.
    Pakai HANYA saat berganti model embedding ke dimensi berbeda, lalu jalankan /ingest.
    """
    return rag_service.reset_rag_table()
